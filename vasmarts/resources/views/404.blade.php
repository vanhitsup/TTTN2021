...
<!-- Mirrored from demo.hasthemes.com/subas-preview-v1/subas/404.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2021 09:28:44 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>V.a Smart || 404</title>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="top-link clearfix">
                            <ul class="link f-right">
                                <li>
                                    <a href="my-account.blade.php">
                                        <i class="zmdi zmdi-account"></i>
                                        Tài khoản
                                    </a>
                                </li>
                                <li>
                                    <a href="wishlist.blade.php">
                        ...
                        <div class="col-lg-8 d-none d-lg-block">
                            <nav id="primary-menu">
                                <ul class="main-menu text-center">
                                    ...
                                    <li class="mega-parent"><a href="shop.blade.php">Shop</a>
                                    </li>
                                    <li class="mega-parent"><a href="shop.blade.php">Danh Mục</a>
                                    ...
                                    <li><a href="blog.blade.php">Bài Viết</a>
                                    </li>
                                    <li>
                                            ...
                                            <li>
                                                <div class="top-cart-inner view-cart">
                                                    <h4 class="text-uppercase">
                                                        <a href="cart.blade.php">Xem Giỏ Hàng</a>
                                                    </h4>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="top-cart-inner check-out">
                                                    <h4 class="text-uppercase">
                                                        <a href="checkout.blade.php">Thanh Toán</a>
                                                    </h4>
                                                </div>
                                            </li>
                                        </ul>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul>
                                ...
                                <li>
                                    <a href="shop.blade.php">Products</a>
                                </li>
                                <li><a href="#">Pages</a>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            <a href="single-product.blade.php">Single Product</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="order.blade.php">Order</a>
                                        </li>
                                        <li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2 d-block d-xl-block d-lg-none d-md-none">
                                <div class="single-footer">
                                    ...
                                    <ul class="footer-menu">
                                        ...
                                        <li>
                                            <a href="#"><i class="zmdi zmdi-circle"></i><span>Các nhà cung cấp</span></a>
                                        </li>
                                        <li>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-3">
                                <div class="single-footer">
                                    ...
                                    <ul class="footer-menu">
                                        <li>
                                            <a href="my-account.blade.php"><i class="zmdi zmdi-circle"></i><span>Tài khoản</span></a>
                                        </li>
                                        <li>
                                            <a href="wishlist.blade.php"><i class="zmdi zmdi-circle"></i><span>Danh sách yêu thích</span></a>
                                        </li>
                                        <li>
                                            <a href="cart.blade.php"><i class="zmdi zmdi-circle"></i><span>Giỏ hàng</span></a>
                                        </li>
                                        <li>
                                            <a href="login.blade.php"><i class="zmdi zmdi-circle"></i><span>Đăng nhập</span></a>
                                        </li>
                                        <li>
                                            <a href="login.blade.php"><i class="zmdi zmdi-circle"></i><span>Đăng ký</span></a>
                                        </li>
                                        <li>
                                            <a href="checkout.blade.php"><i class="zmdi zmdi-circle"></i><span>Thanh toán</span></a>
                                        </li>
...
<!-- Mirrored from demo.hasthemes.com/subas-preview-v1/subas/404.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2021 09:28:45 GMT -->
</html>
